...
fp_env_file_miniconda='https://repo.continuum.io/miniconda/Miniconda3-py311_25.1.1-2-Linux-x86_64.sh'

# Argument(s) default definition(s)
fp_env_tag_default='sliper_runner_data'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy gdal h5py pandas rasterio netCDF4 cython xarray bottleneck dask pip python=3.11
