...
python sliper_app_data_processing_rain_main.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20251003 (1.1.0) --> Operational release
