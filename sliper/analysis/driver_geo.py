...
class DriverGeo:
    ...
    def wrap_geo_data(self, file_name: str, file_type: str,
                      file_format: str, file_mandatory: bool = True, file_tag: str = 'data'):

        # info start
        log_stream.info(' -----> Get source "' + file_tag + '" ... ')
        ...
        # info end
        log_stream.info(' -----> Get source "' + file_tag + '" ... DONE')
    ...
    def organize_data(self):
        ...
        if not os.path.exists(path_name_dst):
            ...
            geo_info = self.wrap_geo_data(
                ...
                file_mandatory=True, file_tag='geo')
            ...
            geo_shp = self.wrap_geo_data(
                ...
                file_mandatory=True, file_tag='shapefile')
