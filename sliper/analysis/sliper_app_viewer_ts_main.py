#!/usr/bin/python3
"""
SLIPER APP - VIEWER TIME-SERIES - Soil Landslide Information and Prediction & Early Response
...
Version(s):
20251013 (1.6.0) --> Operational release; ensure realtime setup and fix bugs related
...
project_name = 'sliper'
alg_name = 'SLIPER APP - VIEWER TIME-SERIES'
alg_type = 'Package'
alg_version = '1.6.0'
alg_release = '2025-10-13'
...
def main():
    ...
    time_run, time_range = set_time(
        ...
        rounding=data_settings['time']['time_rounding'],
