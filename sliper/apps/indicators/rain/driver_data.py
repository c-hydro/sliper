...
class DriverData:
    ...
    def __init__(self, time_run, time_range,
        ...
        self.group_time_types = search_period_by_type(
            ...
            group_search_mode = "common", group_search_operation = "max")
        self.group_time_partition = search_partition_by_type(
            self.group_dset_type, self.group_dset_partition,
            group_search_mode = "common", group_search_operation = "multiple")
    ...
    def analyze_data(self, data_collections: dict, var_name='rain'):
    ...
    def organize_data(self, time_all=True, var_name='rain'):
