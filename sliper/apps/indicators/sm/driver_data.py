...
from lib_utils_data_indicators import search_period_by_type, search_window_by_type, search_partition_by_type
...
class DriverData:
    ...
    def __init__(self, time_run, time_range,
                 ...
                 collections_data_geo_info=None,
        ...
        self.template_ts_first = 'sm_value_first'
        self.template_ts_last = 'sm_value_last'
        self.template_ts_max = 'sm_value_max'
        self.template_ts_avg = 'sm_value_avg'

        self.tag_sep = ':'

        self.group_dset_name = extract_subpart(self.data_group, ['info', 'name'])
        ...
        self.group_dset_partition = extract_subpart(self.data_group, ['datasets', 'search_part'])

        self.group_time_windows = search_window_by_type(self.group_dset_type, self.group_dset_period)
        self.group_time_types = search_period_by_type(
            self.group_dset_type, self.group_dset_period,
            group_search_mode = "separate", group_search_operation = "max")
        self.group_time_partition = search_partition_by_type(
            self.group_dset_type, self.group_dset_partition,
            group_search_mode = "separate", group_search_operation = "unique")
