...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP INDICATORS RAIN - OBS REALTIME'
...
ALG_SETTINGS="/home/admin/soilslips-exec/indicators/sliper_app_indicators_rain_obs_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_indicators}"
LOG_BASENAME="${LOG_BASENAME:-bash_indicators_rain_obs_realtime}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_indicators_rain_obs_realtime}"
