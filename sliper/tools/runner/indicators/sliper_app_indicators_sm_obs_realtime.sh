...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP INDICATORS SM - OBS REALTIME'
...
ALG_SETTINGS="/home/admin/soilslips-exec/indicators/sliper_app_indicators_sm_obs_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_indicators}"
LOG_BASENAME="${LOG_BASENAME:-bash_indicators_sm_obs_realtime}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_indicators_sm_obs_realtime}"
