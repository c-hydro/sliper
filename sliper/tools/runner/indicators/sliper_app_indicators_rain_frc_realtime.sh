...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP INDICATORS RAIN - FRC REALTIME'
...
ALG_FOLDER="/home/admin/library/package_sliper/apps/indicators/rain"
ALG_SCRIPT="/home/admin/library/package_sliper/apps/indicators/rain/sliper_app_indicators_rain_main.py"
ALG_SETTINGS="/home/admin/soilslips-exec/indicators/sliper_app_indicators_rain_frc_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_indicators}"
LOG_BASENAME="${LOG_BASENAME:-bash_indicators_rain_frc_realtime}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_indicators_rain_frc_realtime}"
