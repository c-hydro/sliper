...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP SCENARIOS - OBS REALTIME'
...
ALG_SETTINGS="/home/admin/soilslips-exec/scenarios/sliper_app_scenarios_obs_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_scenarios}"
LOG_BASENAME="${LOG_BASENAME:-bash_scenarios_obs_realtime}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_scenarios_obs_realtime}"
