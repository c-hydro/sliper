...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP PREDICTORS - OBS REALTIME'
...
ALG_FOLDER="/home/admin/library/package_sliper/apps/predictors"
ALG_SCRIPT="/home/admin/library/package_sliper/apps/predictors/sliper_app_predictors_main.py"
ALG_SETTINGS="/home/admin/soilslips-exec/predictors/sliper_app_predictors_obs_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_predictors}"
LOG_BASENAME="${LOG_BASENAME:-bash_predictors_obs_realtime}"
...
LOCK_FOLDER="${LOCK_FOLDER:-/home/admin/lock/runner_predictors}"
LOCK_BASENAME="${LOCK_BASENAME:-bash_predictors_obs_realtime}"
