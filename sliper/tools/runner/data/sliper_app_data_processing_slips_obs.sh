...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP DATA PROCESSING SLIPS - OBS'
...
ALG_FOLDER="/home/admin/library/package_sliper/data/slips"
ALG_SCRIPT="/home/admin/library/package_sliper/data/slips/sliper_app_data_processing_slips_main.py"
ALG_SETTINGS="/home/admin/soilslips-exec/data/sliper_app_data_processing_slips_obs.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_data}"
LOG_BASENAME="${LOG_BASENAME:-bash_data_preprocessing_slips_obs}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_data_preprocessing_slips_obs}"
