...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP DATA PROCESSING RAIN - FRC REALTIME'
...
ALG_FOLDER="/home/admin/library/package_sliper/data/rain"
ALG_SCRIPT="/home/admin/library/package_sliper/data/rain/sliper_app_data_processing_rain_main.py"
ALG_SETTINGS="/home/admin/soilslips-exec/data/sliper_app_data_processing_rain_frc_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_data}"
LOG_BASENAME="${LOG_BASENAME:-bash_data_preprocessing_rain_frc_realtime}"
...
LOCK_FOLDER="${LOCK_FOLDER:-/home/admin/lock/runner_data}"
LOCK_BASENAME="${LOCK_BASENAME:-bash_data_preprocessing_rain_frc_realtime}"
