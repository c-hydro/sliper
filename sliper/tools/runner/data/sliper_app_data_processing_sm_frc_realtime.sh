...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP DATA PROCESSING SM - FRC REALTIME'
...
LOG_BASENAME="${LOG_BASENAME:-bash_data_preprocessing_sm_frc_realtime}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_data_preprocessing_sm_frc_realtime}"
