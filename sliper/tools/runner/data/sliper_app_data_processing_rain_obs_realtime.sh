...
# -----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME='SLIPER - APP DATA PROCESSING RAIN - OBS REALTIME'
...
ALG_SETTINGS="/home/admin/soilslips-exec/data/sliper_app_data_processing_rain_obs_realtime.json"

# log setup
LOG_FOLDER="${LOG_FOLDER:-/home/admin/log/runner_data}"
LOG_BASENAME="${LOG_BASENAME:-bash_data_preprocessing_rain_obs_realtime}"
...
LOCK_BASENAME="${LOCK_BASENAME:-bash_data_preprocessing_rain_obs_realtime}"
