...
class DriverGeo:
    ...
    def __init__(self, src_dict, dst_dict, tmp_dict,
        ...
        self.type_tag, self.format_tag, self.fields_tag = 'type', 'format', 'fields'
        ...
        self.fields_src_info = src_dict_info[self.fields_tag] if self.fields_tag in list(
            src_dict_info.keys()) else None
        ...
        self.fields_src_shp = src_dict_shp[self.fields_tag] if self.fields_tag in list(
            src_dict_shp.keys()) else None
        ...
        if os.path.exists(file_name):
            ...
            if file_format == 'shapefile' or file_format == 'shp':
                ...
                if file_type == 'vector':
                    ...
                    # get file data
                    geo_dframe, geo_collections, geo_geoms = read_file_shp(file_name, file_fields=self.fields_src_shp)
                ...
                if file_type == 'vector':
                    ...
                    tmp_obj = read_file_csv(
                        self.path_name_src_info, fields=self.fields_src_info,
    ...
    def organize_data(self):
        ...
        # Starting info
        log_stream.info(' ----> Organize geographical data ... ')
        ...
        if not os.path.exists(path_name_dst):
            ...
            geo_collections = {
                'info': geo_info,
                'geo_data': geo_da, 'geo_dframe': geo_dframe, 'geo_polygons': geo_polygons}
            ...
            geo_da, geo_polygons = geo_collections['geo_data'], geo_collections['geo_polygons']
            geo_dframe = geo_collections['geo_dframe'] if 'geo_dframe' in geo_collections else None

        # Ending info
        log_stream.info(' ----> Organize geographical data ... DONE')
